...
<body>
  ...
  <form>
    ...
    name="TeacherSignupForm[firstname]" autofocus aria-required="true">
    ...
    name="TeacherSignupForm[lastname]" aria-required="true">
...
name="TeacherSignupForm[username]" aria-required="true">
...
name="TeacherSignupForm[password]" aria-required="true">

<p class="help-block help-block-error"></p>
</div>
            <div class="form-group field-signupform-password required">
<label class="control-label" for="signupform-password">Confirm Password</label>
<input type="password" id="signupform-password-Confirm" placeholder="Password..." class="form-control" name="SignupForm[passwordConfirm]" aria-required="true">
